...
Niche breadth, as measured by different types of generalism, was significantly associated with our urbanization index.  This result was robust across non-phylogenetic and phylogenetic models, model averaging approaches, and across phylogenetic uncertaintly. Conversely, specilized feeding strategies were negatively associated with the urbanization index: granivore and insectivore specialists were much less likely to be found in urban environments. These results suggest that urbanization is, in general, excluding most specialist species.  SOMETHING ABOUT IMPLICATIONS FOR CONSERVATION / FRAGMENTATION.  

The non-random distribution of the urbanization index across the phylogeny (Table 1) is interesting.  This result contrasts with previous studies [@evans2011makes], but this contrasting finding is likely a result of increased statistical power from our larger sample size: 477 species in this study compared with 55 species in Evans *et al.* [-@evans2011makes].  Interestingly many of the predictor traits---generalism, clutch size---have even stronger phylogenetic signal, so it's not surprising that a larger sample size finds a non-random pattern in urbanization across the bird phylogeny.  It is worth noting that this results is consistent with the observation of reduced phylogenetic diversity in urban areas [@la2018phylogenetic], suggesting that there are phylogenetic constraints which allow certain birds to persist within urban environments [@morelli2016evidence; @ibanez2017global; @sol2017urbanisation; @major2010museum].  
...
Brain size at a given body size is an especially interesting trait--it's becomes more important in the phylogenetic model compared to the non-phylogenetic model.  While some studies have found a lack of evidence that relative brain size is critical in urban birds [@kark2007living; @evans2011makes], we confirm those which do support the hypothesis that brain size is heavily correlated with urban birds [@moller2009successful; @maklakov2011brains; @moller2015brain]. Because of the phylogenetic signal in both brain size and urbanization, it is crutial to investigate this relationship in a phylogenetically informed manner.  

Certian aspects of the trait-urbanization relationship appear to consistent across the globe. CHANGE PHRASING BELOW HERE: The relationship with annual fecundity and urbanization in birds is consistent with work in Europe  [@croci2008does; @moller2009successful]. The that urbanization appears to select against insectivorous species [@chace2006urban; @evans2011makes]. While others have found that urbanization supports granivorous species [@chace2006urban; @kark2007living; @evans2011makes], we found the opposite trend, but this could be a result of relatively little supplementary feeding in Australian cities [cf., @fuller2008garden]. We did not find any strong support for our hypotheses on different nesting types, but we did find that in general, species which tended to be more social were at an advantage to city living, confirming previous studies [@coleman1994neophobia; @jokimaki1998distribution; @kark2007living].
