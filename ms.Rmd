...
# DISCUSSION
Niche breadth, as measured by different types of generalism, was significantly associated with urbanization in our analysis. This result was robust across non-phylogenetic and phylogenetic models, model averaging approaches, and across phylogenetic uncertainty. Conversely, specialized feeding strategies were negatively associated with urbanization: granivorous and insectivorous specialists were much less likely to be found in urban environments. These results suggest that urbanization is, in general, excluding specialist species [@sorace2009distribution]. As such, future urban development aimed at increasing avian diversity in urban areas should focus on maintaining a high diversity of habitat [@melles2003urban] both for foraging [@shochat2004linking], and nesting [@fernandez2001habitat], with a focus on intact vegetation [@sushinsky2013should] connected by corridors [@litteral2017role]. A species-specific approach to assess particular resources necessary for specialist species may be necessary [@fernandez2004spatial]. Lastly, a focal point should be on increasing insect abundance and diversity in urban environments [@baldock2015uk], which will in turn increase the presence of insectivorous bird species in urban environments. 
...
We provide the largest study to date using a continuous urbanization metric in order to assess ecological and life history traits which are associated with a species' adaptability to urban environments. Our results suggest that generalist species, with large relative brain size, are better prepared to forage and survive in the ecologically novel aspects of urban environments [@shochat2006patterns]. This work should be extended to test whether our findings can accurately predict species which are commonly found in urban environments in other parts of the world, based on a known suite of traits associated with a given set of species. Australia is a relatively young country with rapid urbanization currently underway [@coffee2016visualising] and fully understanding how birds respond to urban development is critical to inform future management. Urban avian biodiversity could be increased by improving the suitability of foraging for granivores and insectivores, especially important given the recent noted collapse of insects in other parts of the world [@hallmann2017more]. Furthermore, future studies should focus on broad-scale data to form generalizable patterns which rely on continuous measures for improved predictive performance.
