...
```{r Figure 1, echo=FALSE, fig.cap="An example of five different species' average radiance value distributions, on a logarithmic scale."}
knitr::include_graphics("finalFigs/Figure1.pdf")
```

```{r Figure 2, echo=FALSE, fig.cap="The distribution, on a logarithmic scale, of the response variable for the 477 species included in the analysis, with five example species highlighted."}
...
```{r Figure S3, echo=FALSE, fig.cap="Phylogenetic uncertainty for some of the most important predictor variables included in the analysis."}
