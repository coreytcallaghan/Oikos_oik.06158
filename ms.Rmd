...
```{r Figure 1, echo=FALSE, fig.cap="An example of five different species' average radiance value distributions, on a logarithmic scale. These species were chosen because they represent species with differnt distributional responses."}
...
```{r Figure 3, echo=FALSE, fig.cap="A phylogenetic tree, based on Jetz et al. (2012) of the 477 bird species in the analysis. The tree demonstrates the urbanization index for each species in two ways: (1) coloring of the tips where dark red equates to a low urbanization index and dark blue equates to a high urbanization index, and (2) the size of the barplot portrayed for a species at its tip show the relative urbanization index. The urbanization index was taken as the median of the distribution for a species' average radiance values. Figure S2 shows a reference phylogenetic tree with the names of each tip displayed, and this link () provides an interactive visualization in order to easily identify each of the 477 species in the tree. For a full list of the 477 species included and their urbanization index see Appendix 4."}
...
```{r Figure S1, echo=FALSE, fig.cap="A correlation plot for the continuous variables used in the analysis."}
knitr::include_graphics("finalFigs/FigureS1.pdf")
```

```{r Figure S2, echo=FALSE, fig.cap="A reference phylogenetic tree, with labeled tips, for each of the 477 species included in the analysis. Appendix 4 lists the 477 species."}
knitr::include_graphics("finalFigs/FigureS2.pdf")
```

```{r Figure S3, echo=FALSE, fig.cap="An assessment of phylogenetic uncertainty for some of the most important predictor variables included in the analysis."}
