...
knitr::include_graphics("final figures for paper/Figure4.pdf")
```
...
knitr::include_graphics("final figures for paper/Figure5.pdf")
```
...
knitr::include_graphics("figures/accounting_for_phylo_uncertainty.pdf")
```
